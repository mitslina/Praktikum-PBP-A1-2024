<!--
    Setelah menambahkan real_escape_string() update data berhasil dijalankan.
    Hal ini karena pada saat kita menggunakan karakter ' (single quote) pada suatu field,
    maka query akan menjadi salah karena syntax error. Dengan menggunakan real_escape_string() karakter ' (single quote)
    akan diubah menjadi \' (backslash single quote) sehingga query dapat dijalankan dengan benar.
-->
