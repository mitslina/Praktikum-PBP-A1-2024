    ...
    <div class="card-body">
        ...
        <form name="regist" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="player_name" id="player_name" class="form-control" value="<?php echo isset($player_name) ? $player_name : ''; ?>"><!-- TAMPILKAN INPUTAN JIKA TELAH DIISIKAN -->
            ...
            <div class="form-group">
                ...
                <input type="email" onblur="getCharacter()" name="email" id="email" class="form-control" value="<?php echo isset($email) ? $email : ''; ?>"><!-- TAMPILKAN INPUTAN JIKA TELAH DIISIKAN -->
